...
abstract class NotificationMixin extends BetaSeriesObjectMixin {
	...
	NotificationMixin(
			...
			@JsonProperty("type") @JsonDeserialize(using=BSNotificationTypeDeserializer.class) BSNotificationType type, 
			@JsonProperty("ref_id")	String refId,
			@JsonProperty("text") String text, 
			@JsonProperty("html") String html, 
			@JsonProperty("date") @JsonDeserialize(using = BSNotificationDateDeserializer.class) Date date,			
